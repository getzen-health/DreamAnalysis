...
const models = [
  {
    ...
    algo: "LightGBM + Feature Heuristics",
    liveAccuracy: "65–75%",
    benchmarkAccuracy: "86.11% (GBM, within-subj)",
    crossSubject: "45.3% (DEAP, cross-subj)",
    classes: 6,
    ...
    novelty:
      "Mastoid re-reference + DASM/RASM across 5 bands + FMT + 4-sec epoch buffer + BaselineCalibrator (+15–29% accuracy). Feature heuristics tuned for Muse 2 dry electrodes rather than 32-ch gel datasets.",
    status: "active",
    category: "Emotion",
    color: "violet",
  },
...
const datasets = [
  ...
  },
  {
    ...
    accuracy: 0,
    f1: 0,
    cvMethod: "Pending access",
    note: "Most relevant dataset — 14-ch consumer EEG is closest to Muse 2. Requires data access request.",
    caveat: "⚠ Restricted. Contact stamos.katsigiannis@durham.ac.uk for access",
    status: "restricted",
  },
  {
    name: "EmoKeyMuseS",
...
const differentiation = [
  ...
  },
  {
    ...
    thisWork:
      "17 models running in parallel: emotion, sleep (5 stages), dream detection, flow, creativity, memory, drowsiness, cognitive load, attention, stress, lucid dream, meditation, anomaly, artifact, denoising, online learner, food-emotion. All connected through a single FastAPI.",
    advantage: true,
  },
  {
  ...
  },
  {
    ...
    thisWork:
      "Complete web app: React frontend (17 pages) + Express.js middleware + FastAPI ML backend + PostgreSQL + Vercel deployment. Any user can access it with a Muse 2 headband and a browser.",
    advantage: true,
  },
  {
    ...
    thisWork:
      "8 datasets: DEAP, SEED, GAMEEMO, EEG-ER, EmoKeyMuseS, Brainwave, DREAMER (pending), FACED (pending). Cross-dataset transfer explicitly modeled. Training scripts for all 8.",
    advantage: true,
  },
];
...
const publishingPlan = [
  ...
  {
    step: 4,
    title: "DREAMER Dataset Access + Training",
    status: "todo",
    detail:
      "Request DREAMER dataset (23 subjects, 14-ch Emotiv — closest to Muse 2). Email stamos.katsigiannis@durham.ac.uk. Retrain emotion classifier on DREAMER to demonstrate consumer-hardware-specific performance.",
    timeline: "2–4 weeks",
  },
  {
    step: 5,
...
const pipeline = [
  ...
  { layer: "React Frontend", description: "17-Page Web App", detail: "Real-time EEG visualisation, dream journal, emotion timeline, neurofeedback training, brain connectivity map, health analytics, AI companion, meditation tracker, food-emotion dashboard." },
];
      ...
      <div className="relative overflow-hidden border-b border-white/5">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-16">
          ...
          <p className="mt-5 max-w-3xl text-lg text-white/65">
            17 ML models, 8 EEG datasets, 76 API endpoints, and one novel food-emotion
          ...
          <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
            {[
              ...
              { label: "API Endpoints", value: "76" },
              { label: "EEG Datasets", value: "8" },
              { label: "Web Pages", value: "17" },
      ...
      <div className="mx-auto max-w-7xl px-6 py-14 space-y-20">
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-white/5">
                {[
                  ...
                  { cond: "Muse 2, no calibration, our system", binary: "~50–55%", six: "45.3% (DEAP)", note: "Real world — close to chance" },
            ...
            {[
              ...
              },
              {
                ...
                items: [
                  ...
                  "Run full BaselineCalibrator protocol in live UI (guided 2-min rest)",
        ...
        <div className="border-t border-white/8 pt-10 text-center">
          ...
          <p className="mt-2 text-xs text-white/25">
            17 ML models · 76 API endpoints · 8 EEG datasets · Muse 2 · FastAPI · React · PostgreSQL
          </p>
