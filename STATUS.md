...
| Emotion Classifier | LightGBM mega (global PCA) | **89.25% CV** (DEAP+DENS, 3-class, 85 features) | DEAP + DENS | **Active live path** — scaler+PCA+LGBM in single pkl, auto-loaded |
